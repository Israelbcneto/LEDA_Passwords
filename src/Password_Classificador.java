...
public class Password_Classificador {

    public void classificarPasswords(String inputFile, String outputFile) {
        String line;
        String csvSplitBy = ",";
        String csvQuotedBy = "\"";
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(inputFile));
            ...
            escreve.append(",password,length,data,class\n");
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (data.length >= 3) {
                    ...
                    escreve.append(String.valueOf(lineNumber - 1)).append(",").append(String.join(",", csvQuotedBy + data[1] + csvQuotedBy, String.valueOf(length), data[3], passwordClass));
                    escreve.append("\n");
                }
            }
