public class QuickSortMedianaTres {
    ...
    public void length(String[] data, String nameCase) {
        ...
        System.out.println("Tempo de execução Quick Sort (Mediana de 3) p/ o " + nameCase + ": " + duracao + " milissegundos");
        String filename = "";
    ...
    private void quickSortLength(String[] array, int inicio, int fim, GetInput v) {
        if (inicio < fim) {
    ...
    private int partitionLength(String[] array, int inicio, int fim, GetInput v) {
