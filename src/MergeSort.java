public class MergeSort {
    ...
    private void mergeSortLength(String[] array, int inicio, int fim, GetInput v) {
        if (inicio < fim) {
    ...
    private void mergeLength(String[] array, int inicio, int meio, int fim, GetInput v) {
    ...
    private void mergeSortMonth(String[] array, int inicio, int fim, GetInput v) {
        if (inicio < fim) {
            int meio = (inicio + fim) / 2;
    ...
    private void mergeMonth(String[] array, int inicio, int meio, int fim, GetInput v) {
        int n1 = meio - inicio + 1;
        int n2 = fim - meio;
    ...
    private void mergeSortDate(String[] array, int inicio, int fim, GetInput v) {
        if (inicio < fim) {
            int meio = (inicio + fim) / 2;
    ...
    private void mergeDate(String[] array, int inicio, int meio, int fim, GetInput v) {
        int n1 = meio - inicio + 1;
        int n2 = fim - meio;
